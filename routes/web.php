...
Route::get('/slideshow', ['as'=>'slideshow','uses'=>'App\Http\Controllers\GaleriController@slideshow'])->middleware('1');
Route::post('/slideshow/add', ['as'=>'store_slideshow','uses'=>'App\Http\Controllers\GaleriController@store_slideshow']);
Route::get('/slideshow/create', ['as'=>'create_slideshow','uses'=>'App\Http\Controllers\GaleriController@create_slideshow'])->middleware('1');
